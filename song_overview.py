...
def song_interpreter(lyrics):
    ...
    prompt="Lyrics:"+lyrics+"\n\nExtract these details:\n1) In three sentences, thoughtfully analyze the meaning of these lyrics in a paragraph, including an exploration of any symbols or metaphors.\n2) In one word, describe the mood of these lyrics.\n3) List three themes of these lyrics, comma separated.\nDesired format: Analysis: <answer_1>|:|Mood: <answer_2>|:|Themes: <answer_3>\nResponse:",
    temperature=0.7,
    max_tokens=256,
    top_p=1,
    frequency_penalty=0,
